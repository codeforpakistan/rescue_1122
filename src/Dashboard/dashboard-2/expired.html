...
<!--from here copy-->
 <div class="panel panel-default">
							<div class="panel-heading"><h4><b> Expired Patients (July 2016 to September 2016) </b></h4></div>
...
var WFSLayer;
			...
			var geoJsonUrl = "http://localhost:8080/geoserver/wfs?version=1.1.0&request=GetFeature&typename=rescue1122:Expiredpatientsperpolygon&outputFormat=application/json&srsname=EPSG:4326&"
				$.ajax({
				 url : geoJsonUrl,
			...
			legend.onAdd = function(map){
				...
				div.innerHTML += '<i style="background:' + getColor(3) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 2" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(5) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 4" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(7) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 6" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(9) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 8" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(11) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 10" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(13) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 12" + '<br />';
				return div;
