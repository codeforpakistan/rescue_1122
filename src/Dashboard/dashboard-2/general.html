...
<!--from here copy-->
 <div class="panel panel-default">
							<div class="panel-heading"><h4> <b> Total Calls (July 2016 to September 2016) </b> </h4></div>
	...
	var WFSLayer_1;
			...
			legend.onAdd = function(map){
				...
				div.innerHTML += '<i style="background:' + getColor(97) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 96" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(145) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 144" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(193) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 192" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(241) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 240" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(289) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 288" + '<br />';
				return div;
