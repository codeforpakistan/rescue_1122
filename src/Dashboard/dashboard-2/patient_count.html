...
<!--from here copy-->
 <div class="panel panel-default">
							<div class="panel-heading"><h4> <b>	Patient Count (July 2016 to September 2016) </b></h4></div>
	...
	var WFSLayer;
			...
			var geoJsonUrl = "http://localhost:8080/geoserver/wfs?version=1.1.0&request=GetFeature&typename=rescue1122:patient_count&outputFormat=application/json&srsname=EPSG:4326&"
				$.ajax({
				 url : geoJsonUrl,
            ...
            onEachFeature: function (feature, layer) {
                ...
                layer.bindPopup(feature.properties.zone_name + 
			...
			legend.onAdd = function(map){
				...
				div.innerHTML += '<i style="background:' + getColor(50) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 49" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(99) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 98" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(148) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 147" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(197) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 196" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(246) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 245" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(295) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 294" + '<br />';
				return div;
