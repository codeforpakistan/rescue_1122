...
<!--from here copy-->
 <div class="panel panel-default">
							<div class="panel-heading"><h4><b> Caller Count on Thursday (July 2016 to September 2016) </b></h4></div>
	...
	var WFSLayer;
			...
			var geoJsonUrl = "http://localhost:8080/geoserver/wfs?version=1.1.0&request=GetFeature&typename=rescue1122:callercount_thursday&outputFormat=application/json&srsname=EPSG:4326&"
				$.ajax({
				 url : geoJsonUrl,
			...
			legend.onAdd = function(map){
				...
				div.innerHTML += '<i style="background:' + getColor(8) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 7" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(15) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 14" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(22) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 21" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(29) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 28" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(36) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 35" + '<br />';
