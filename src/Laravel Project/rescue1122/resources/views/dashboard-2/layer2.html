...
<!--from here copy-->
 <div class="panel panel-default">
							<div class="panel-heading"><h4><b> Tracks of Vehicle Registration No (RA-16) for August 2016</h4></div>
...
var WFSLayer;
	var WFSLayer_1;
			...
			var geoJsonUrl = "http://localhost:8080/geoserver/wfs?version=1.1.0&request=GetFeature&typename=rescue1122:augtrack&outputFormat=application/json&srsname=EPSG:4326&"
				$.ajax({
				 url : geoJsonUrl,
