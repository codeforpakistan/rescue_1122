...
<!--from here copy-->
 <div class="panel panel-default">
							<div class="panel-heading"><h4> <b> Total calls in Noon (July 2016 to September 2016) </b></h4></div>
    ...
    <script>
			...
			legend.onAdd = function(map){
				...
				div.innerHTML += '<i style="background:' + getColor(16) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 15" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(31) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 30" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(46) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 45" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(61) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 60" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(76) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 75" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(91) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 90" + '<br />';
				return div;
