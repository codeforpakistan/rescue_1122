...
<!--from here copy-->
 <div class="panel panel-default">
							<div class="panel-heading"><h4> <b> Total calls in Morning (July 2016 to September 2016) </b></h4></div>
    ...
    <script>
			...
			var geoJsonUrl = "http://localhost:8080/geoserver/wfs?version=1.1.0&request=GetFeature&typename=rescue1122:Callercountperpolygonatmorning&outputFormat=application/json&srsname=EPSG:4326&"
				$.ajax({
				 url : geoJsonUrl,
			...
			legend.onAdd = function(map){
				...
				div.innerHTML += '<i style="background:' + getColor(15) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 14" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(29) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 28" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(43) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 42" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(57) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 56" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(71) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 70" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(85) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 84" + '<br />';
				return div;
