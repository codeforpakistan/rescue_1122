...
<!--from here copy-->
 <div class="panel panel-default">
							<div class="panel-heading"><h4><b>Caller Count on Saturday (July 2016 to September 2016)</b></h4></div>
	...
	var WFSLayer;
			...
			var geoJsonUrl = "http://localhost:8080/geoserver/wfs?version=1.1.0&request=GetFeature&typename=rescue1122:callercount_saturday&outputFormat=application/json&srsname=EPSG:4326&"
				$.ajax({
				 url : geoJsonUrl,
			...
			legend.onAdd = function(map){
				...
				div.innerHTML += '<i style="background:' + getColor(19) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 18" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(25) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 24" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(31) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 30" + '<br />';
