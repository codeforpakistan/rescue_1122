...
<!--from here copy-->
 <div class="panel panel-default">
							<div class="panel-heading"><h4> <b> Total Calls in Evening (July 2016 to September 2016) </b></h4></div>
    ...
    <script>
			...
			legend.onAdd = function(map){
				...
				div.innerHTML += '<i style="background:' + getColor(12) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 11" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(23) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 22" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(34) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 33" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(45) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 44" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(56) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 55" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(67) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 66" + '<br />';
				return div;
