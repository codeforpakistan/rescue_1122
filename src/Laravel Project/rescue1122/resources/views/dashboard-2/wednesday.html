...
<!--from here copy-->
 <div class="panel panel-default">
							<div class="panel-heading"><h4> <b> Caller Count on Wednesday (July 2016 to September 2016)</b></h4></div>
	...
	var WFSLayer;
			...
			var geoJsonUrl = "http://localhost:8080/geoserver/wfs?version=1.1.0&request=GetFeature&typename=rescue1122:callercount_wednesday&outputFormat=application/json&srsname=EPSG:4326&"
				$.ajax({
				 url : geoJsonUrl,
			...
			legend.onAdd = function(map){
				...
				div.innerHTML += '<i style="background:' + getColor(9) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 8" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(17) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 16" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(25) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 24" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(33) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 32" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(41) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 40" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(49) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 48" + '<br />';
				return div;
