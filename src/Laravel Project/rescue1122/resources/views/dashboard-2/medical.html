...
<!--from here copy-->
 <div class="panel panel-default">
							<div class="panel-heading"><h4><b>Medical Emergency (July 2016 to September 2016)</b></h4></div>
			...
			var geoJsonUrl = "http://localhost:8080/geoserver/wfs?version=1.1.0&request=GetFeature&typename=rescue1122:Medicalcountperpolygon&outputFormat=application/json&srsname=EPSG:4326&"
				$.ajax({
				 url : geoJsonUrl,
			...
			legend.onAdd = function(map){
				...
				div.innerHTML += '<i style="background:' + getColor(18) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 17" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(35) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 34" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(52) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 51" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(69) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 68" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(86) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 85" + '<br />';
				div.innerHTML += '<i style="background:' + getColor(103) + '">&nbsp;&nbsp;</i>&nbsp;&nbsp;'	+ "Count > 102" + '<br />';
				return div;
