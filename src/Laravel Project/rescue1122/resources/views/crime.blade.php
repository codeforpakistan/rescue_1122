...
<!--from here copy-->
 <div class="panel panel-default">
							<div class="panel-heading"><h4><b> Crime Emergency (July 2016 to September 2016) </b> </h4></div>
			...
			var geoJsonUrl = "http://localhost:8080/geoserver/wfs?version=1.1.0&request=GetFeature&typename=rescue1122:Crimecountperpolygon&outputFormat=application/json&srsname=EPSG:4326&"
				$.ajax({
				 url : geoJsonUrl,
